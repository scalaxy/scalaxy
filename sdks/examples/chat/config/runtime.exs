...
# -- Scalaxy connection (official Escalaxy SDK) -------------------------
config :chat,
  escalaxy_url: System.get_env("SCALAXY_URL", "http://localhost:8080"),
  escalaxy_db: System.get_env("SCALAXY_DB", "chat")

config :ash, ash_domains: [Chat.Domain]
